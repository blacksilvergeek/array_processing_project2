...
addpath(dataFolder);
%% mode set and variables
% mode options: Rn known, Rn unknown
mode = "Rn unknown";
bf = "delay and sum"; % beamformer options: wiener, mvdr, delay and sum
test_ratio = 0;
ratio1 = test_ratio;
ratio2 = test_ratio;
ratio3 = test_ratio;
...
subplot(3,1,2)
plot(s_est1)
title('Recovered speech signal with 10dB range ratio (Delay and sum beamformer)')
subplot(3,1,3)
plot(s_est)
title('Recovered speech signal with 0dB range ratio (Delay and sum beamformer)')
